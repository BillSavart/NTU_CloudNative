...
Fake data 以 24/7 晶圓廠輪班模型產生：員工依 id 雜湊分到日班(07:30/12h)、辦公(09:00/9h+加班，僅平日)、夜班(19:30/12h，跨夜到隔天早上)、大夜(00:00/8h)、中班(15:00/8.5h) 等班別，主門 `gate_{fab}_A` 記上下班、B-E 門記廠內移動。因此**全天 24 小時都有人進出、任何時刻廠內都有人在班**，且每日上下班時間與工時都有隨機變異（不會所有人工時一致）。載入當下仍在班的人（下班事件晚於現在而被裁掉）會呈現為「在廠內」。
